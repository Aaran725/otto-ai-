...
Rules:
- "intent" is the ranking style: "undervalued" (cheap/value), "momentum" (hot/trending/breakout), "quality" (safe/stable/defensive), "avoid" (red flags/risky), "best" (general "good stock" ask, or no clearer signal). Use null only if this message isn't a stock-screening request at all.
